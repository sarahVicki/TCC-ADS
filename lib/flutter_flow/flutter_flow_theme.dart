...
abstract class FlutterFlowTheme {
  ...
  late Color chamoisee;
  late Color brownSugar;
  late Color rawUmber;
  late Color bole;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color almond = Color(0xFFEDE0D4);
  late Color dun = Color(0xFFE6CCB2);
  late Color tan = Color(0xFFDDB892);
  late Color coffee = Color(0xFF7F5539);
  late Color paleDogwood = Color(0xFFEDC4B3);
  late Color buff = Color(0xFFDEAB90);
  late Color buff2 = Color(0xFFD69F7E);
  late Color buff3 = Color(0xFFCD9777);
  late Color persianOrange = Color(0xFFC38E70);
  late Color chamoisee = Color(0xFFB07D62);
  late Color brownSugar = Color(0xFF9D6B53);
  late Color rawUmber = Color(0xFF8A5A44);
  late Color bole = Color(0xFF774936);
  late Color customColor2 = Color(0xFF79392F);
}
