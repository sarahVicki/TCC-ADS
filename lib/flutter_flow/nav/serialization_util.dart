    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case SalaoRow:
            return SalaoRow(data);
          case HorariosRow:
            return HorariosRow(data);
          case EnderecoRow:
            return EnderecoRow(data);
          case EspecialidadesRow:
            return EspecialidadesRow(data);
          case AvaliacaoRow:
            return AvaliacaoRow(data);
          case FavoritosRow:
            return FavoritosRow(data);
          case ServicosRow:
            return ServicosRow(data);
          case VincularSalProfRow:
            return VincularSalProfRow(data);
          case ProfissionalRow:
            return ProfissionalRow(data);
          case CategoriasRow:
            return CategoriasRow(data);
          case RedesRow:
            return RedesRow(data);
          case ClienteRow:
