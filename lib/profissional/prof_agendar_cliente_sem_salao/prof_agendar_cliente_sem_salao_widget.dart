...
import 'prof_agendar_cliente_sem_salao_model.dart';
export 'prof_agendar_cliente_sem_salao_model.dart';

class ProfAgendarClienteSemSalaoWidget extends StatefulWidget {
  const ProfAgendarClienteSemSalaoWidget({
    super.key,
    this.refProf,
  ...
  @override
  State<ProfAgendarClienteSemSalaoWidget> createState() =>
      _ProfAgendarClienteSemSalaoWidgetState();
}

class _ProfAgendarClienteSemSalaoWidgetState
    extends State<ProfAgendarClienteSemSalaoWidget>
    with TickerProviderStateMixin {
  late ProfAgendarClienteSemSalaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfAgendarClienteSemSalaoModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'prof-agendarClienteSemSalao'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('PROF_AGENDAR_CLIENTE_SEM_SALAO_prof-agen');
      logFirebaseEvent('prof-agendarClienteSemSalao_backend_call');
      ...
      // DataSemana
      logFirebaseEvent('prof-agendarClienteSemSalao_DataSemana');
      _model.diaSemana = functions.verificaDiaSemana(getCurrentTimestamp);
      safeSetState(() {});
      // StatusDia
      logFirebaseEvent('prof-agendarClienteSemSalao_StatusDia');
      ...
      if (_model.statusDia == 'Aberto') {
        // HoraInicio
        logFirebaseEvent('prof-agendarClienteSemSalao_HoraInicio');
        ...
        safeSetState(() {});
        // HoraFim
        logFirebaseEvent('prof-agendarClienteSemSalao_HoraFim');
        _model.horaFim = _model.horariosSalao
            ?.elementAtOrNull(0)
            ?.horaFechamento
            ?.elementAtOrNull(_model.diaSemana!);
        safeSetState(() {});
        logFirebaseEvent('prof-agendarClienteSemSalao_action_block');
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ServicosRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ServicosRow> profAgendarClienteSemSalaoServicosRowList =
            snapshot.data!;

        final profAgendarClienteSemSalaoServicosRow =
            profAgendarClienteSemSalaoServicosRowList.isNotEmpty
                ? profAgendarClienteSemSalaoServicosRowList.first
                : null;
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('PROF_AGENDAR_CLIENTE_SEM_SALAO_arrow_bac');
                                        ...
                                        FlutterFlowCalendar(
                                          ...
                                          onChange: (DateTimeRange?
                                            ...
                                            _model.calendarSelectedDay =
                                                newSelectedDate;
                                            logFirebaseEvent(
                                                'PROF_AGENDAR_CLIENTE_SEM_SALAO_Calendar_');
                                            logFirebaseEvent(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  if ((_model.statusDia == 'Aberto') &&
                                                      (functions
                                                              .gerarHorariosProf(
                                                                  profAgendarClienteSemSalaoServicosRow!
                                                                      .idProf
                                                                      .toList(),
                                                                  _model
                                                                      .calendarSelectedDay!
                                                                  ...
                                                                  profAgendarClienteSemSalaoServicosRow!.tempo!)
                                                              ...
                                                              itemBuilder:
                                                                ...
                                                                return InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'PROF_AGENDAR_CLIENTE_SEM_SALAO_Container');
                                                                    logFirebaseEvent(
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: ((_model.horaClicada == null) &&
                                ...
                                : () async {
                                    logFirebaseEvent(
                                        'PROF_AGENDAR_CLIENTE_SEM_SALAO_AGENDAR_B');
                                    if (profAgendarClienteSemSalaoServicosRow
                                                ?.idSalao !=
                                            null &&
                                        profAgendarClienteSemSalaoServicosRow
                                                ?.idSalao !=
