...
import 'prof_agendar_cliente_sem_salao_widget.dart'
...
class ProfAgendarClienteSemSalaoModel
    extends FlutterFlowModel<ProfAgendarClienteSemSalaoWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in prof-agendarClienteSemSalao widget.
