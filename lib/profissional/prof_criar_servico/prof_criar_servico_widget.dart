...
import 'prof_criar_servico_model.dart';
export 'prof_criar_servico_model.dart';

class ProfCriarServicoWidget extends StatefulWidget {
  const ProfCriarServicoWidget({super.key});

  @override
  State<ProfCriarServicoWidget> createState() => _ProfCriarServicoWidgetState();
}

class _ProfCriarServicoWidgetState extends State<ProfCriarServicoWidget> {
  late ProfCriarServicoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfCriarServicoModel());
                    ...
                    children: [
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        TextFormField(
                                          controller:
                                              _model.nomeServicoTextController,
                                          focusNode:
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'PROF_CRIAR_SERVICO_CRIAR_SERVIO_BTN_ON_T');
                            logFirebaseEvent('Button_update_component_state');
                            _model.addToIdProf(currentUserUid);
                            safeSetState(() {});
                            logFirebaseEvent('Button_backend_call');
                            await ServicosTable().insert({
                              'nome': _model.nomeServicoTextController.text,
                              'valor': double.tryParse(
                                  _model.precoTextController.text),
                              'tempo': int.tryParse(
                                  _model.duracaoTextController.text),
                              'id_prof': _model.idProf,
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'PROF_CRIAR_SERVICO_CANCELAR_BTN_ON_TAP');
                          logFirebaseEvent('Button_close_dialog_drawer_etc');
                          Navigator.pop(context);
                        },
                        text: 'Cancelar',
