...
import 'profissional_calendario_model.dart';
export 'profissional_calendario_model.dart';

class ProfissionalCalendarioWidget extends StatefulWidget {
  const ProfissionalCalendarioWidget({super.key});

  @override
  State<ProfissionalCalendarioWidget> createState() =>
      _ProfissionalCalendarioWidgetState();
}

class _ProfissionalCalendarioWidgetState
    extends State<ProfissionalCalendarioWidget> with TickerProviderStateMixin {
  late ProfissionalCalendarioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfissionalCalendarioModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Profissional-Calendario'});
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ProfissionalRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProfissionalRow> profissionalCalendarioProfissionalRowList =
            snapshot.data!;

        final profissionalCalendarioProfissionalRow =
            profissionalCalendarioProfissionalRowList.isNotEmpty
                ? profissionalCalendarioProfissionalRowList.first
                : null;
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('PROFISSIONAL_CALENDARIO_arrow_back_round');
            ...
            body: Column(
              ...
              children: [
                                      ...
                                      child: FlutterFlowCalendar(
                                        ...
                                        onChange: (DateTimeRange?
                                          ...
                                          _model.calendarSelectedDay1 =
                                              newSelectedDate;
                                          logFirebaseEvent(
                                              'PROFISSIONAL_CALENDARIO_Calendar_v1c8zj3');
                                          logFirebaseEvent(
                                                    ...
                                                    Completer<
                                                      ...
                                                      ..complete(
                                                        ...
                                                        queryFn: (q) => q
                                                            .eqOrNull(
                                                              'id_prof',
                                                              profissionalCalendarioProfissionalRow
                                                                  ?.idProf,
                                                            )
                                                            .gtOrNull(
                                                              'data_agendada',
                                                          ...
                                                          Builder(
                                                            builder: (context) =>
                                                              ...
                                                              onPressed: (getCurrentTimestamp >
                                                                  ...
                                                                  : () async {
                                                                      logFirebaseEvent(
                                                                          'PROFISSIONAL_CALENDARIO_CANCELAR_BTN_ON_');
                                                                      logFirebaseEvent(
                                                                          'Button_alert_dialog');
                                                                      await showDialog(
                                                                        context:
                                      ...
                                      child: FlutterFlowCalendar(
                                        ...
                                        onChange: (DateTimeRange?
                                          ...
                                          _model.calendarSelectedDay2 =
                                              newSelectedDate;
                                          logFirebaseEvent(
                                              'PROFISSIONAL_CALENDARIO_Calendar_uaxm8w7');
                                          logFirebaseEvent(
                                              'Calendar_refresh_database_request');
                                          safeSetState(() =>
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          valueOrDefault<
                                                                              String>(
                                                                            semanalAgendamentosRow.enderecoCliente,
                                                                            'Endereço não cadastrado',
                                                                          ),
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
                ...
                wrapWithModel(
                  model: _model.profissionalNavBarCalendarioModel,
                  updateCallback: () => safeSetState(() {}),
                  child: ProfissionalNavBarCalendarioWidget(),
                ),
              ],
            ),
          ),
