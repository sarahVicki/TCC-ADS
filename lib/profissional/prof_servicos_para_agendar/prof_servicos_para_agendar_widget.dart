...
import 'prof_servicos_para_agendar_model.dart';
export 'prof_servicos_para_agendar_model.dart';

class ProfServicosParaAgendarWidget extends StatefulWidget {
  const ProfServicosParaAgendarWidget({
    super.key,
  ...
  @override
  State<ProfServicosParaAgendarWidget> createState() =>
      _ProfServicosParaAgendarWidgetState();
}

class _ProfServicosParaAgendarWidgetState
    extends State<ProfServicosParaAgendarWidget> with TickerProviderStateMixin {
  late ProfServicosParaAgendarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfServicosParaAgendarModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Prof-servicosParaAgendar'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('PROF_SERVICOS_PARA_AGENDAR_arrow_back_ro');
                                  ...
                                  FutureBuilder<List<ServicosRow>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemCount:
                                            servicosProfServicosRowList.length,
                                        itemBuilder:
                                            (context, servicosProfIndex) {
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: FutureBuilder<
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    final textSalaoRow = textSalaoRowList
                                                                            .isNotEmpty
                                                                        ? textSalaoRowList
                                                                            .first
                                                                        : null;
                                                      ...
                                                      FFButtonWidget(
                                                        onPressed: () async {
                                                          logFirebaseEvent(
                                                              'PROF_SERVICOS_PARA_AGENDAR_AGENDAR_BTN_O');
                                                          logFirebaseEvent(
                                                              'Button_navigate_to');

                                                          context.pushNamed(
                                                            'prof-agendarClienteComSalao',
                                                            queryParameters: {
                                                              'refProf':
                                                                  serializeParam(
              ...
              Expanded(
                child: Align(
                  ...
                  child: Padding(
                    ...
                    child: wrapWithModel(
                      model: _model.profissionalNavBarAgendamentoModel,
                      updateCallback: () => safeSetState(() {}),
                      child: ProfissionalNavBarAgendamentoWidget(),
                    ),
                  ),
                ),
              ),
