...
import 'prof_editar_servico_model.dart';
export 'prof_editar_servico_model.dart';

class ProfEditarServicoWidget extends StatefulWidget {
  const ProfEditarServicoWidget({
    super.key,
  ...
  @override
  State<ProfEditarServicoWidget> createState() =>
      _ProfEditarServicoWidgetState();
}

class _ProfEditarServicoWidgetState extends State<ProfEditarServicoWidget> {
  late ProfEditarServicoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfEditarServicoModel());
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'PROF_EDITAR_SERVICO_EDITAR_SERVIO_BTN_ON');
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'PROF_EDITAR_SERVICO_CANCELAR_BTN_ON_TAP');
                              logFirebaseEvent(
                                  'Button_close_dialog_drawer_etc');
                              Navigator.pop(context);
                            },
