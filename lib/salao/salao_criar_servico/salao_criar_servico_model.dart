...
import 'dart:ui';
import 'salao_criar_servico_widget.dart' show SalaoCriarServicoWidget;
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class SalaoCriarServicoModel extends FlutterFlowModel<SalaoCriarServicoWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in Salao-CriarServico widget.
  List<ProfissionalRow>? profissionais;
