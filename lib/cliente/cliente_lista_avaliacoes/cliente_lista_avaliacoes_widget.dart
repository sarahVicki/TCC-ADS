...
import 'cliente_lista_avaliacoes_model.dart';
export 'cliente_lista_avaliacoes_model.dart';

class ClienteListaAvaliacoesWidget extends StatefulWidget {
  const ClienteListaAvaliacoesWidget({
    super.key,
    required this.refSalao,
  });

  final SalaoRow? refSalao;

  @override
  State<ClienteListaAvaliacoesWidget> createState() =>
      _ClienteListaAvaliacoesWidgetState();
}

class _ClienteListaAvaliacoesWidgetState
    extends State<ClienteListaAvaliacoesWidget> {
  late ClienteListaAvaliacoesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClienteListaAvaliacoesModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Cliente-ListaAvaliacoes'});
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('CLIENTE_LISTA_AVALIACOES_arrow_back_roun');
